...
```{r}
first_climbed_vector <- c(1953,1954,1955,1956,1955)
mountains <- tibble(mountain_vector, mountain_height_feet_vector, mountain_height_meters_vector,first_climbed_vector)
```
...
```{r}
summits <- c(12884,800,500,900,500)
```
...
```{r}
fatality_rate_percentage <- c()
```

```{r}
mountains <- tibble(mountain_vector, mountain_height_feet_vector, mountain_height_meters_vector,first_climbed_vector, summits, fatalities, fatality_rate_percentage)
```
