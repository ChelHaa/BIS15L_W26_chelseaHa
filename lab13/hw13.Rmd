...
amniota_na %>% 
  group_by(class) %>% 
  summarise(mass_NA=sum(is.na(egg_mass_g)))
```

Biologically, yes this does make sense because mammals don't lay eggs so they should have a higher number than birds (aves) who actually do lay eggs. There should be less NAs for the birds and more NAs for mammals.
