...
```{}
mv genome01_blastn.csv BIS15L_W26_chelseaHa/lab16/data/blast_results/
ls BIS15L_W26_chelseaHa/lab16/data/blast_results/
```
...
```{}
mv blastp_results.csv BIS15L_W26_chelseaHa/lab16/data/blast_results/
ls BIS15L_W26_chelseaHa/lab16/data/blast_results/
```
...
```{r}
read.csv("data/blast_results/blastp_results.csv")
```
